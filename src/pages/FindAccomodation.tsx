import { IonImg, IonContent, IonHeader, IonPage, IonTitle, IonToolbar, IonItem, IonLabel, IonSelectOption, IonSelect ,IonText, IonCard, IonRange, IonList, IonCardHeader, IonCardContent, IonCardTitle, IonInput} from '@ionic/react';
        ...
        <IonPage>
          ...
          <IonContent className="ion-padding">
            <IonItem>
              ...
              <IonSelect className='right-aligned' value={type} placeholder="Select Type" onIonChange={(e) => setType(e.detail.value)}>
